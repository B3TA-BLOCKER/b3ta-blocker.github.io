    ...
    <>
      <div>
        ...
        <div className="flex sm:space-x-6">
          {/* Sidebar */}
          <div className="hidden h-full max-h-screen max-w-[220px] min-w-[220px] flex-wrap overflow-auto rounded-sm bg-gray-50 pt-5 shadow-md sm:flex dark:bg-gray-900/70 dark:shadow-gray-800/40">
