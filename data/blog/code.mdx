---
title: "Code Machine (HackTheBox) — Step-by-Step Walkthrough"
date: "2025-08-06"
draft: false
tags: ["linux", "hackthebox", "easy", "python-sandbox-escape", "path-traversal", "privilege-escalation"]
summary: "Compromise of a Linux HackTheBox machine by escaping a Python code editor sandbox via subclass traversal to obtain a reverse shell, extracting and cracking MD5 credentials from a SQLite database, then escalating privileges by abusing a sudo-permitted backup script with a crafted JSON payload to read the root flag."
images: ["/static/images/code/preview.png"]
---

![Code](/static/images/code/head.png)
...
![Code](/static/images/code/image.png)
...
![Code](/static/images/code/image%201.png)
...
![Code](/static/images/code/image%202.png)
...
![Code](/static/images/code/image%203.png)
...
![Code](/static/images/code/image%204.png)
...
![Code](/static/images/code/image%205.png)
...
![Code](/static/images/code/image%206.png)
...
![Code](/static/images/code/image%207.png)
