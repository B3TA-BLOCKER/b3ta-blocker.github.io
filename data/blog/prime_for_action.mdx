...
platform: 'HackTheBox'
tags: ['cpp', 'challenge', 'very-easy', 'hackthebox', 'coding']
...
The service serves an in-browser code editor over the socket. Default language was Python, but I switched to C++ since that's what I'm most comfortable working under time pressure in.
...
- Trivial once you notice this is a "filter + multiply" problem, not a crypto challenge.
- Worth remembering `long long` for the product — two primes in the 1000–5000 range multiply well past `int` range on most systems.
