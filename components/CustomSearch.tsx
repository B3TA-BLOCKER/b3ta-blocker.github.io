    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          />
          <span style={{ color: '#8b949e', fontSize: '12px', flex: 1, textAlign: 'center' }}>
            b3ta-blocker@archive — search
          </span>
        </div>
            ...
            {results.map((doc, idx) => (
              <li key={doc.path} style={{ borderTop: idx !== 0 ? '1px solid #21262d' : 'none' }}>
                ...
                >
                  ...
                  <span style={{ color: '#484f58', fontSize: '13px', flexShrink: 0 }}>→</span>
                </Link>
              </li>
            ))}
          </ul>
        ...
        {query && results.length === 0 && (
          <div style={{ padding: '48px 16px', textAlign: 'center' }}>
            <p style={{ fontSize: '13px', color: '#8b949e' }}>
              No results for <span style={{ color: '#c9d1d9' }}>"{query}"</span>
            </p>
