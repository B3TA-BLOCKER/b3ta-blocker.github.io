...
export default function Terminal() {
  ...
  const fileContents: Record<string, Line[]> = {
    ...
    'goals.txt': [
      ...
      {t:'plain', v:'  → Build tools that matter in real red team ops'},
      {t:'empty', v:''},
    ...
    'books.txt': [
      ...
      {t:'empty', v:''},
      {t:'blue', v:'1. Hacking: The Art of Exploitation'},
